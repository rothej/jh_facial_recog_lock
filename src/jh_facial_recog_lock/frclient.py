...
pushSocket.bind("tcp://192.168.1.139:55002") # custom - modify if this is an add'l client
...
def exitHandler(sig, frame):                                # custom
    ...
    pushSocket.unbind("tcp://192.168.1.139:55001")          # custom, change pased on target IP
...
class FaceRecognition:
    ...
    def new_recognition(self, results):
        ...
        if self.unlock_counter == 7:                                                                    # custom
            ...
            self.unlock_counter = self.unlock_counter + 1                                               # custom
        if self.unlock_counter == 25:                                                                   # custom
